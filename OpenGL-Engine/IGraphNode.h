...
namespace rendering {
	...
	public:
		...
		*/
		...
		int GetNodeCount(void) const				{ return this->m_children.size(); }

		// Gets the basis of this node
		glm::mat4x4 GetBasis(void) const			{ return this->m_basis; }

		// Sets the basis of this node
		void SetBasis(glm::mat4x4 const& basis)		{ this->m_basis = basis; }

		// Gets the GUID of this node
		GUID GetID() const noexcept					{ return this->m_id; }

		// Gets the parent of this node
		IGraphNode* GetParent() const noexcept		{ return this->m_parent; }

		// Sets manually the parent of this node
		void SetParent(IGraphNode* parent) noexcept { this->m_parent = parent; }
